...
const News = () => {
  ...
  const fetchData = async () => {
    let resonse = await fetch(
      "https://newsapi.org/v2/top-headlines?sources=bbc-news&apiKey=714ef9b8a6ef47d19b4bda6f4f0d100f"
    );
  ...
  return (
    <>
    <h1 className="text-center my-3 text-white-50">Top - Headlines</h1>
